...
Заполнить низкоуровневые таблицы именами(животных), командами которые они выполняют и датами рождения
    ...
    ('Рубик', '2020-01-09', 'кличка,ко мне', 1),
    ('Персик', '2021-06-12', 'кличка,голос', 1),  
    ('Ася', '2017-12-04', 'кличка,голос,ко мне', 1),
    ('Фиона', '2018-08-21', 'кличка,сидеть,ползи,принеси,голос,прыжок,ко мне', 1),
    ('Смоки', '2019-05-11', 'кличка,сидеть,ползи,принеси,голос,прыжок,ко мне', 1),
    ('Лиззи', '2022-07-08', 'кличка,кис-кис', 1);
    
    INSERT INTO hamsters (name, birthday, commands, id_genus) VALUES
    ('Банни', '2020-01-08', 'стоять,поворот,фу,прыгай,найти', 1),
    ('Черныш', '2021-06-22', 'стоять,фу,прыгай,найти', 1),  
    ('Бонни', '2019-05-16', 'стоять,поворот,фу,прыгай,найти', 1),
    ('Джей', '2018-05-30', 'стоять,поворот,фу', 1),
    ('Винни', '2018-12-31', 'стоять,фу,найти', 1),
    ('Хома', '2021-05-10', 'стоять,поворот,фу,прыгай', 1);
    
    -- pack_animals tables data --
    
    INSERT INTO horses (name, birthday, commands, id_genus) VALUES
    ('Виконт', '2015-01-24', 'вперёд,стой,рысь,хоп,шагом,тише', 2),
    ('Буран', '2019-03-28', 'вперёд,стой,тише', 2),  
    ('Базилик', '2016-09-12', 'вперёд,стой,рысь,хоп,шагом', 2),
    ('Гранат', '2016-07-09', 'вперёд,стой,рысь,хоп,шагом,тише', 2),
    ('Астон', '2018-09-14', 'вперёд,стой,рысь,хоп', 2),
    ('Апполон', '2021-11-10', 'вперёд,стой', 2);
